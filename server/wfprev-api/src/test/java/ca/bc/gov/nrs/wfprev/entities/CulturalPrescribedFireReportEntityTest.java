...
class CulturalPrescribedFireReportEntityTest {
    ...
    void testAllFields() {
        ...
        entity.setRclFilterSectionComment("RCL comment");
        entity.setTotalBdfFilterSectionScore(decimal);
        entity.setBdfFilterSectionComment("BDF comment");
        entity.setTotalCollimpFilterSectionScore(decimal);
        entity.setCollimpFilterSectionComment("Collimp comment");
        ...
        assertThat(entity.getRclFilterSectionComment()).isEqualTo("RCL comment");
        assertThat(entity.getTotalBdfFilterSectionScore()).isEqualTo(decimal);
        assertThat(entity.getBdfFilterSectionComment()).isEqualTo("BDF comment");
        assertThat(entity.getTotalCollimpFilterSectionScore()).isEqualTo(decimal);
        assertThat(entity.getCollimpFilterSectionComment()).isEqualTo("Collimp comment");
