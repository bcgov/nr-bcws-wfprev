...
public class PlanFiscalStatusCodeEntityTest {

    @Test
    public void test_create_entity_with_all_fields() {
        // Given
        String planFiscalStatusCode = "PFS123";
        String description = "Sample Fiscal Status Description";
        ...
        // When
        PlanFiscalStatusCodeEntity entity = PlanFiscalStatusCodeEntity.builder()
        ...
        assertEquals(planFiscalStatusCode, entity.getPlanFiscalStatusCode());
    ...
    public void test_date_fields_timezone_conversion() {
        // Given
        PlanFiscalStatusCodeEntity entity = PlanFiscalStatusCodeEntity.builder()
                .planFiscalStatusCode("PFS123")
                .description("Test Fiscal Status Description")
    ...
    public void test_equals_and_hashcode() {
        // Given
        PlanFiscalStatusCodeEntity entity1 = PlanFiscalStatusCodeEntity.builder()
                .planFiscalStatusCode("PFS123")
                .description("Plan Fiscal Status 123")
                .displayOrder(1)
                .effectiveDate(new Date())
                .expiryDate(new Date())
                .revisionCount(0)
        ...
        PlanFiscalStatusCodeEntity entity2 = PlanFiscalStatusCodeEntity.builder()
                .planFiscalStatusCode("PFS123")
                .description("Plan Fiscal Status 123")
                .displayOrder(1)
