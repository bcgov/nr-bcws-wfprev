...
//
//       doAnswer(invocation -> null).when(reportService).exportXlsx(any(), any(), any(), anyString());
//
...
//       UUID guid = UUID.randomUUID();
//
//       doAnswer(invocation -> null).when(reportService).writeCsvZipFromEntities(any(), any(), any());
//
//       ReportRequestModel request = new ReportRequestModel();
