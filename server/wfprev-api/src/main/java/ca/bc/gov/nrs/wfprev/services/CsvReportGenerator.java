...
public class CsvReportGenerator {
    ...
    private String getResultsCsvHeader() {
        return String.join(",", List.of(
                "Link to Project (within within ReMi Planner)",
                "Link to Fiscal Activity (within ReMi Planner)",
                "Project Name",
                ...
                "Org Unit",
                "Project Lead Email",
                "Inter-Agency No. Licensee Opening ID",
                "Opening ID",
                "Opening Action",
                "Opening Category",
                "Opening Area (Ha)",
                ...
                "Additional Objective for Tracking OPTIONAL",
                "Completed Date",
                "Treatment Area",
                "Funding Source Code",
                "Comment",
                "Tenure Number (License, CP, Block)",
                "Planned Treatment Area",
                "Contract Phase",
                "CFS Code",
                "Carry over from previous activity",
                "Carry forward to a future fiscal activity",
                "Final Outcome & Comments",
                "Outstanding Obligations (Y/N)",
                "Plan for addressing outstanding obligations and work to be carried forward",
                "Opening shape file name",
                "Activity shape file name (completed and planned activities)",
                "Forest Cover shape file name",
