...
ECR_TARGET_ACCOUNT_ID = "${get_env("ECR_TARGET_ACCOUNT_ID")}"
...
WFPREV_LIQUIBASE_COMMAND_PASSWORD = "${get_env("WFPREV_LIQUIBASE_COMMAND_PASSWORD")}"
APP_WF1_PREV_LIQUIBASE_COMMAND_PASSWORD = "${get_env("APP_WF1_PREV_LIQUIBASE_COMMAND_PASSWORD")}"
