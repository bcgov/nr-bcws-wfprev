...
//       spyOn(component, 'renderActivityBoundaries');
//       spyOn(component, 'createMap').and.returnValue(mapSpy);
//       spyOn(component, 'createMarker').and.returnValue(markerSpy);
//       spyOn(component, 'createGeoJSON').and.returnValue(geoJsonLayerSpy);
//       markerSpy.addTo.and.returnValue(markerSpy as any);
//       geoJsonLayerSpy.addTo.and.returnValue(geoJsonLayerSpy);
...
//        component['mapHost'] = { nativeElement: document.createElement('div') } as any;
...
//       expect(component.createMap).toHaveBeenCalled(); // Verify that the map is created
//       expect(component.createMarker).toHaveBeenCalledWith(
//         [49.553209, -119.965887],
//         jasmine.objectContaining({
//           icon: jasmine.any(Object)
