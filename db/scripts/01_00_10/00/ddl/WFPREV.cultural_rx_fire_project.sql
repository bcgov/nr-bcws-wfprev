...
/*  Created On : 21-Jan-2025 3:44:44 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

/* Create Tables */

CREATE TABLE "wfprev"."cultural_rx_fire_project"
(
	"cultural_rx_fire_project_guid" UUID NOT NULL,    -- cultural_rx_fire_project_guid is a unique identifier for the record.
...
COMMENT ON TABLE "wfprev"."cultural_rx_fire_project"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."cultural_rx_fire_project_guid"
	IS 'cultural_rx_fire_project_guid is a unique identifier for the record.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."project_guid"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."wui_risk_class_code"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."local_wui_risk_class_code"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."wui_risk_class_comment"
	IS 'Wildland Urban Interface Risk Class Comment are general comments regarding the Wildland Urban Interface Risk Class.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."local_wui_risk_class_rationale"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."coarse_filter_comment"
	IS 'Coarse Filter Comment contains the rationale or additional comments regarding the coarse filters for the project.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."revision_count"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_project"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."cultural_rx_fire_project" ADD CONSTRAINT "capfp_pk"
	PRIMARY KEY ("cultural_rx_fire_project_guid")
;

ALTER TABLE "wfprev"."cultural_rx_fire_project" ADD CONSTRAINT "capfp_uk" UNIQUE ("project_guid")
;

CREATE INDEX "capfp_prjct_idx" ON "wfprev"."cultural_rx_fire_project" ("project_guid" ASC)
;

CREATE INDEX "capfp_wuirccd_idx" ON "wfprev"."cultural_rx_fire_project" ("wui_risk_class_code" ASC)
;

CREATE INDEX "capfp_wuirccd_local_idx" ON "wfprev"."cultural_rx_fire_project" ("local_wui_risk_class_code" ASC)
;

/* Create Foreign Key Constraints */

ALTER TABLE "wfprev"."cultural_rx_fire_project" ADD CONSTRAINT "capfp_prjct_fk"
	FOREIGN KEY ("project_guid") REFERENCES "wfprev"."project" ("project_guid") ON DELETE No Action ON UPDATE No Action
;

ALTER TABLE "wfprev"."cultural_rx_fire_project" ADD CONSTRAINT "capfp_wuirccd_fk"
...
ALTER TABLE "wfprev"."cultural_rx_fire_project" ADD CONSTRAINT "capfp_wuirccd_local_fk"
