...
/*  Created On : 21-Jan-2025 4:29:22 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

/* Create Tables */

CREATE TABLE "wfprev"."cultural_rx_fire_plan_audit"
(
	...
	"cultural_rx_fire_plan_guid" UUID NULL,    -- cultural_rx_fire_plan_guid is a unique identifier for the record.
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."audit_table_sequence"
	IS 'Added by transform - intent is make this sequence noncached so order is maintained'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."audit_action_code"
	IS 'Contains the reason the audit record is written - Insert/Update/Delete/Conversion'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."cultural_rx_fire_plan_guid"
	IS 'cultural_rx_fire_plan_guid is a unique identifier for the record.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."project_plan_fiscal_guid"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."burn_impl_season_code"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."developed_with_first_natio_ind"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."first_nations_partnership_ind"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."maximizes_funding_integr_ind"
	IS 'Maximizes Funding and Integration Ind indicates whether Funding and Integration has been maximized for the project (Y) or not (N).  Projects that maximize non-CLWRR funding sources (ex: LBI, HCTF) or have value integration linkages with activities, projects or programs undertaken to achieve broader government objectives (ex: ecosystem restoration, other WRR work, habitat restoration, silviculture, etc).'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."capacity_development_opp_ind"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."revision_count"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."cultural_rx_fire_plan_audit" ADD CONSTRAINT "cpfp_aud_pk"
