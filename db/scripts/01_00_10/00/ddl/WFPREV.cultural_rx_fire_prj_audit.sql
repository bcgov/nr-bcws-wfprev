...
/*  Created On : 21-Jan-2025 3:44:25 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

/* Create Tables */

CREATE TABLE "wfprev"."cultural_rx_fire_prj_audit"
(
	...
	"cultural_rx_fire_project_guid" UUID NULL,    -- cultural_rx_fire_project_guid is a unique identifier for the record.
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."audit_table_sequence"
	IS 'Added by transform - intent is make this sequence noncached so order is maintained'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."audit_action_code"
	IS 'Contains the reason the audit record is written - Insert/Update/Delete/Conversion'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."cultural_rx_fire_project_guid"
	IS 'cultural_rx_fire_project_guid is a unique identifier for the record.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."project_guid"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."wui_risk_class_code"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."local_wui_risk_class_code"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."wui_risk_class_comment"
	IS 'Wildland Urban Interface Risk Class Comment are general comments regarding the Wildland Urban Interface Risk Class.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."local_wui_risk_class_rationale"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."coarse_filter_comment"
	IS 'Coarse Filter Comment contains the rationale or additional comments regarding the coarse filters for the project.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."revision_count"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_prj_audit"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."cultural_rx_fire_prj_audit" ADD CONSTRAINT "capfp_aud_pk"
