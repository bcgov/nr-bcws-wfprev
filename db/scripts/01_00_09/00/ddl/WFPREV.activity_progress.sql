...
/*  Created On : 13-Jan-2025 4:02:48 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

/* Create Tables */

CREATE TABLE "wfprev"."activity_progress"
(
	"activity_progress_guid" UUID NOT NULL,    -- activity_progress_guid is a unique identifier for the record.
...
COMMENT ON TABLE "wfprev"."activity_progress"
	IS 'Activity Progress records the progress made to date on activities within a project fiscal plan as reported by the business area.'
;

COMMENT ON COLUMN "wfprev"."activity_progress"."activity_progress_guid"
	IS 'activity_progress_guid is a unique identifier for the record.'
;

COMMENT ON COLUMN "wfprev"."activity_progress"."activity_guid"
...
COMMENT ON COLUMN "wfprev"."activity_progress"."project_plan_fiscal_perf_guid"
...
COMMENT ON COLUMN "wfprev"."activity_progress"."entered_timestamp"
	IS 'Entered Timestamp is the date and time the comment was entered.'
;

COMMENT ON COLUMN "wfprev"."activity_progress"."activity_status_code"
...
COMMENT ON COLUMN "wfprev"."activity_progress"."contract_phase_code"
...
COMMENT ON COLUMN "wfprev"."activity_progress"."risk_rating_code"
...
COMMENT ON COLUMN "wfprev"."activity_progress"."reported_spend_amount"
...
COMMENT ON COLUMN "wfprev"."activity_progress"."commenter_guid"
...
COMMENT ON COLUMN "wfprev"."activity_progress"."system_generated_ind"
	IS 'System Generated Ind indicates whether or not the comment was generated by the application (''Y'') or was user entered (''N'').'
;

COMMENT ON COLUMN "wfprev"."activity_progress"."outstanding_obligations_ind"
...
COMMENT ON COLUMN "wfprev"."activity_progress"."activity_comment"
	IS 'Treatment Activity Comment is used to document activity comments including outstanding obligations.'
;

COMMENT ON COLUMN "wfprev"."activity_progress"."revision_count"
...
COMMENT ON COLUMN "wfprev"."activity_progress"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."activity_progress"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."activity_progress"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."activity_progress"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."activity_progress" ADD CONSTRAINT "actprg_pk"
	PRIMARY KEY ("activity_progress_guid")
;

ALTER TABLE "wfprev"."activity_progress" ADD CONSTRAINT "actprg_uk" UNIQUE ("activity_guid","project_plan_fiscal_perf_guid","entered_timestamp")
;

CREATE INDEX "actprg_actvty_idx" ON "wfprev"."activity_progress" ("activity_guid" ASC)
;

CREATE INDEX "actprg_actscd_idx" ON "wfprev"."activity_progress" ("activity_status_code" ASC)
;

CREATE INDEX "actprg_cphcd_idx" ON "wfprev"."activity_progress" ("contract_phase_code" ASC)
;

CREATE INDEX "actprg_ppfyprf_idx" ON "wfprev"."activity_progress" ("project_plan_fiscal_perf_guid" ASC)
;

CREATE INDEX "actprg_rrcd_idx" ON "wfprev"."activity_progress" ("risk_rating_code" ASC)
;

/* Create Foreign Key Constraints */

ALTER TABLE "wfprev"."activity_progress" ADD CONSTRAINT "actprg_actscd_fk"
...
ALTER TABLE "wfprev"."activity_progress" ADD CONSTRAINT "actprg_cphcd_fk"
...
ALTER TABLE "wfprev"."activity_progress" ADD CONSTRAINT "actprg_ppfyprf_fk"
	FOREIGN KEY ("project_plan_fiscal_perf_guid") REFERENCES "wfprev"."project_plan_fiscal_perf" ("project_plan_fiscal_perf_guid") ON DELETE No Action ON UPDATE No Action
;

ALTER TABLE "wfprev"."activity_progress" ADD CONSTRAINT "actprg_actvty_fk"
	FOREIGN KEY ("activity_guid") REFERENCES "wfprev"."activity" ("activity_guid") ON DELETE No Action ON UPDATE No Action
;

ALTER TABLE "wfprev"."activity_progress" ADD CONSTRAINT "actprg_rrcd_fk"
