...
COMMENT ON COLUMN "wfprev"."project"."total_actual_project_size_ha"
	IS 'Total Actual Project Size Ha is the total land size in hectares that have been treated by the project. This will be a sum of all the land treated to date.'
;

COMMENT ON COLUMN "wfprev"."project"."total_actual_cost_per_hectare_amount"
	IS 'Total Actual Cost Per Hectare Amount is the cost per hectare for the project for all fiscal years. It is calculated as Total Actual Amount divided by Total Project Size Ha.'
;
