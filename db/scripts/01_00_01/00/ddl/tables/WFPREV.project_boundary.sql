...
/*  Created On : 14-Nov-2024 10:35:36 AM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

/* Create Tables */

CREATE TABLE "wfprev"."project_boundary"
(
	"project_boundary_guid" UUID NOT NULL,    -- project_boundary_guid is a unique identifier for the record.
...
COMMENT ON TABLE "wfprev"."project_boundary"
	IS 'Project Boundary is a point-in-time capture of the boundary area of a project.   Boundaries are maintained in a desktop GIS tool and uploaded to WF1.'
;

COMMENT ON COLUMN "wfprev"."project_boundary"."project_boundary_guid"
	IS 'project_boundary_guid is a unique identifier for the record.'
;

COMMENT ON COLUMN "wfprev"."project_boundary"."project_guid"
...
COMMENT ON COLUMN "wfprev"."project_boundary"."revision_count"
...
COMMENT ON COLUMN "wfprev"."project_boundary"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."project_boundary"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."project_boundary"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."project_boundary"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."project_boundary" ADD CONSTRAINT "prjbnd_pk"
	PRIMARY KEY ("project_boundary_guid")
;

ALTER TABLE "wfprev"."project_boundary" ADD CONSTRAINT "prjbnd_uk" UNIQUE ("project_guid","system_start_timestamp","system_end_timestamp")
;

CREATE INDEX "prjbnd_prjct_idx" ON "wfprev"."project_boundary" ("project_guid" ASC)
;

/* Create Foreign Key Constraints */

ALTER TABLE "wfprev"."project_boundary" ADD CONSTRAINT "prjbnd_prjct_fk"
