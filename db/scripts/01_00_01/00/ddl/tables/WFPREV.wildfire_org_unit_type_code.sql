...
CREATE TABLE "wfprev"."wildfire_org_unit_type_code"
(
	"wildfire_org_unit_type_code" varchar(10)	 NOT NULL,    -- wildfire_org_unit_type_code: Wildfire Org Unit Type Code defines the type of the org unit.  Values:  	- Ministry 	- Fire Centre   	- Zone
...
COMMENT ON TABLE "wfprev"."wildfire_org_unit_type_code"
	IS 'Wildfire Org Unit Type Code defines the type of the org unit.  Values:  	- Ministry 	- Fire Centre   	- Zone'
;

COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."wildfire_org_unit_type_code"
	IS 'wildfire_org_unit_type_code: Wildfire Org Unit Type Code defines the type of the org unit.  Values:  	- Ministry 	- Fire Centre   	- Zone'
;

COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."description"
	IS 'DESCRIPTION is the display quality description of the code value.'
;

COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."display_order"
	IS 'DISPLAY ORDER is to allow non alphabetic sorting e.g. M T W Th F S S.'
;

COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."effective_date"
	IS 'EFFECTIVE_DATE is the date code value becomes effective.'
;

COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."expiry_date"
	IS 'EXPIRY_DATE is the date code value expires.'
;

COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."revision_count"
...
COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."wildfire_org_unit_type_code"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."wildfire_org_unit_type_code" ADD CONSTRAINT "woutcd_pk"
	PRIMARY KEY ("wildfire_org_unit_type_code")
;