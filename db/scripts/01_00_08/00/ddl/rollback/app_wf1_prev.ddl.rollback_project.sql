ALTER TABLE wfprev.project ADD  COLUMN IF NOT EXISTS total_funding_request_amount decimal(15,2) NULL;
...
ALTER TABLE wfprev.project_audit ADD COLUMN IF NOT EXISTS total_funding_request_amount decimal(15,2) NULL;
COMMENT ON COLUMN "wfprev"."project_audit"."total_funding_request_amount"
	IS 'Total Funding Request Amount is the dollar amount requested to fund the completion of the proposed project activities for all fiscal years.';


ALTER TABLE wfprev.project ADD COLUMN  IF NOT EXISTS  total_allocated_amount decimal(15,2) NULL;
...
ALTER TABLE wfprev.project_audit ADD COLUMN  IF NOT EXISTS  total_allocated_amount decimal(15,2) NULL;
