...
/*  Created On : 20-Dec-2024 4:08:26 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

/* Create Tables */

CREATE TABLE "wfprev"."project_plan_status_code"
(
	"project_plan_status_code" varchar(10)	 NOT NULL,    -- project_plan_status_code: Project Plan Status Code is the status of a prevention project plan for a fiscal year. Values are:  	- Active 	- Deleted 	- Archived
...
COMMENT ON TABLE "wfprev"."project_plan_status_code"
	IS 'Project Plan Status Code is the status of a prevention project plan for a fiscal year. Values are:  	- Active 	- Deleted 	- Archived'
;

COMMENT ON COLUMN "wfprev"."project_plan_status_code"."project_plan_status_code"
	IS 'project_plan_status_code: Project Plan Status Code is the status of a prevention project plan for a fiscal year. Values are:  	- Active 	- Deleted 	- Archived'
;

COMMENT ON COLUMN "wfprev"."project_plan_status_code"."description"
	IS 'DESCRIPTION is the display quality description of the code value.'
;

COMMENT ON COLUMN "wfprev"."project_plan_status_code"."display_order"
	IS 'DISPLAY ORDER is to allow non alphabetic sorting e.g. M T W Th F S S.'
;

COMMENT ON COLUMN "wfprev"."project_plan_status_code"."effective_date"
	IS 'EFFECTIVE_DATE is the date code value becomes effective.'
;

COMMENT ON COLUMN "wfprev"."project_plan_status_code"."expiry_date"
	IS 'EXPIRY_DATE is the date code value expires.'
;

COMMENT ON COLUMN "wfprev"."project_plan_status_code"."revision_count"
...
COMMENT ON COLUMN "wfprev"."project_plan_status_code"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."project_plan_status_code"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."project_plan_status_code"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."project_plan_status_code"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."project_plan_status_code" ADD CONSTRAINT "ppscd_pk"
	PRIMARY KEY ("project_plan_status_code")
;