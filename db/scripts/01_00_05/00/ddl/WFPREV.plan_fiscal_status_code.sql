...
CREATE TABLE "wfprev"."plan_fiscal_status_code"
(
	"plan_fiscal_status_code" varchar(10)	 NOT NULL,    -- plan_fiscal_status_code: Plan Fiscal Status Code is the set of statuses a project plan may transition through. Values are:  	- Draft 	- Proposed 	- In Preparation 	- In Progress 	- Complete 	- Abandoned
...
COMMENT ON TABLE "wfprev"."plan_fiscal_status_code"
	IS 'Plan Fiscal Status Code is the set of statuses a project plan may transition through. Values are:  	- Draft 	- Proposed 	- In Preparation 	- In Progress 	- Complete 	- Abandoned'
;

COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."plan_fiscal_status_code"
	IS 'plan_fiscal_status_code: Plan Fiscal Status Code is the set of statuses a project plan may transition through. Values are:  	- Draft 	- Proposed 	- In Preparation 	- In Progress 	- Complete 	- Abandoned'
;

COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."description"
	IS 'DESCRIPTION is the display quality description of the code value.'
;

COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."display_order"
	IS 'DISPLAY ORDER is to allow non alphabetic sorting e.g. M T W Th F S S.'
;

COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."effective_date"
	IS 'EFFECTIVE_DATE is the date code value becomes effective.'
;

COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."expiry_date"
	IS 'EXPIRY_DATE is the date code value expires.'
;

COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."revision_count"
...
COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."plan_fiscal_status_code"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."plan_fiscal_status_code" ADD CONSTRAINT "pfystcd_pk"
	PRIMARY KEY ("plan_fiscal_status_code")
;