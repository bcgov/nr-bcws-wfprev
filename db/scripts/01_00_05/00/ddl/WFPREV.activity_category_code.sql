...
/*  Created On : 20-Dec-2024 4:07:36 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

/* Create Tables */

CREATE TABLE "wfprev"."activity_category_code"
(
	"activity_category_code" varchar(10)	 NOT NULL,    -- activity_category_code: Activity Category Code is the set of activity categories that may be performed for a project.   Values are:  	- Tactical Planning 	- Prescription Development 	- Maintenance - Survey 	- Maintenance - Operational Treatment 	- Other (Assessments/Surveys) 	- Other (Administration) 	- Integrated Fuel Management Planning.
...
COMMENT ON TABLE "wfprev"."activity_category_code"
	IS 'Activity Category Code is the set of activity categories that may be performed for a project.   Values are:  	- Tactical Planning 	- Prescription Development 	- Maintenance - Survey 	- Maintenance - Operational Treatment 	- Other (Assessments/Surveys) 	- Other (Administration) 	- Integrated Fuel Management Planning.'
;

COMMENT ON COLUMN "wfprev"."activity_category_code"."activity_category_code"
	IS 'activity_category_code: Activity Category Code is the set of activity categories that may be performed for a project.   Values are:  	- Tactical Planning 	- Prescription Development 	- Maintenance - Survey 	- Maintenance - Operational Treatment 	- Other (Assessments/Surveys) 	- Other (Administration) 	- Integrated Fuel Management Planning.'
;

COMMENT ON COLUMN "wfprev"."activity_category_code"."description"
	IS 'DESCRIPTION is the display quality description of the code value.'
;

COMMENT ON COLUMN "wfprev"."activity_category_code"."display_order"
	IS 'DISPLAY ORDER is to allow non alphabetic sorting e.g. M T W Th F S S.'
;

COMMENT ON COLUMN "wfprev"."activity_category_code"."effective_date"
	IS 'EFFECTIVE_DATE is the date code value becomes effective.'
;

COMMENT ON COLUMN "wfprev"."activity_category_code"."expiry_date"
	IS 'EXPIRY_DATE is the date code value expires.'
;

COMMENT ON COLUMN "wfprev"."activity_category_code"."revision_count"
...
COMMENT ON COLUMN "wfprev"."activity_category_code"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."activity_category_code"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."activity_category_code"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."activity_category_code"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."activity_category_code" ADD CONSTRAINT "actcatcd_pk"
