...
/*  Created On : 20-Dec-2024 4:21:57 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */

/* Create Tables */

CREATE TABLE "wfprev"."project_plan_fiscal_audit"
(
	...
	"project_plan_fiscal_guid" UUID NULL,    -- project_plan_fiscal_guid is a unique identifier for the record.
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."audit_table_sequence"
	IS 'Added by transform - intent is make this sequence noncached so order is maintained'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."audit_action_code"
	IS 'Contains the reason the audit record is written - Insert/Update/Delete/Conversion'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."project_plan_fiscal_guid"
	IS 'project_plan_fiscal_guid is a unique identifier for the record.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."project_guid"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."activity_category_code"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."fiscal_year"
	IS 'Fiscal Year is the fiscal year the project proposal is being submitted for.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."ancillary_funding_source_guid"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."project_plan_status_code"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."plan_fiscal_status_code"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."endorsement_code"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."project_fiscal_name"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."project_fiscal_description"
	IS 'Project Fiscal Description is a description of the project proposal for the fiscal year. '
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."business_area_comment"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."estimated_clwrr_alloc_amount"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."total_cost_estimate_amount"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."cfs_project_code"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."fiscal_ancillary_fund_amount"
	IS 'Fiscal Ancillary Funding Amount is the amount of dollars that will be funded by an ancillary funding source.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."fiscal_planned_project_size_ha"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."fiscal_planned_cost_per_ha_amt"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."fiscal_reported_spend_amount"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."fiscal_actual_amount"
	IS 'Fiscal Actual Amount is the total amount actually spent on the project for the fiscal year.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."fiscal_completed_size_ha"
	IS 'Fiscal Completed Size Ha is the sum of hectares for completed activities for the fiscal year.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."fiscal_actual_cost_per_ha_amt"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."first_nations_deliv_part_ind"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."first_nations_engagement_ind"
	IS 'First Nations Engagement Ind indicates whether there is First Nations engagement with the project (Y) or not (N).'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."first_nations_partner"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."other_partner"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."results_number"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."results_opening_id"
	IS 'RESULTS Opening Id is the identifier for an Opening in the RESULTS system if one exists for the project.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."results_contact_email"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."submitted_by_name"
	IS 'Submitted By Name is the display name of the person who submitted the project plan.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."submitted_by_user_guid"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."last_progress_update_timestamp"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."revision_count"
...
COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."project_plan_fiscal_audit"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."project_plan_fiscal_audit" ADD CONSTRAINT "prjpfy_aud_pk"
