...
BEGIN
  ...
  IF ((TG_OP = 'INSERT') OR (TG_OP = 'UPDATE')) THEN
    INSERT INTO wfprev.activity_audit(
      ...
      previous_carry_forward_ind,
      carry_forward_ind,
      final_outcome_comments,
      revision_count,
      create_user,
      create_date,
      update_user,
    ...
    VALUES (
      ...
      NEW.previous_carry_forward_ind,
      NEW.carry_forward_ind,
      NEW.final_outcome_comments,
      NEW.revision_count,
      NEW.create_user,
      NEW.create_date,
      NEW.update_user,
  ...
  ELSIF (TG_OP = 'DELETE') THEN
    ...
    VALUES (
      ...
      OLD.previous_carry_forward_ind,
      OLD.carry_forward_ind,
      OLD.final_outcome_comments,
      OLD.revision_count,
      OLD.create_user,
      OLD.create_date,
      OLD.update_user,
