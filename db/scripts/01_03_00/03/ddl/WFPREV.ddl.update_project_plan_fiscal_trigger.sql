CREATE OR REPLACE FUNCTION wfprev.fnc_audit_project_plan_fiscal()
RETURNS trigger
LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
  ...
  IF ((TG_OP = 'INSERT') OR (TG_OP = 'UPDATE')) THEN
    INSERT INTO wfprev.project_plan_fiscal_audit(
      ...
      proposal_type_code,
      ancillary_funding_provider,
      approved_comment,
      endorse_appr_update_name,
      endorse_appr_update_user_guid,
      endorse_appr_update_userid,
      endorse_appr_updated_timestamp,
      is_bcws_hq_approved_ind,
      bcws_hq_approver_name,
      bcws_hq_approver_user_guid,
      bcws_hq_approver_user_userid,
      bcws_hq_approved_timestamp,
      bcws_hq_approved_comment
    )
    VALUES (
      ...
      NEW.ancillary_funding_provider,
      NEW.approved_comment,
      NEW.endorse_appr_update_name,
      NEW.endorse_appr_update_user_guid,
      NEW.endorse_appr_update_userid,
      NEW.endorse_appr_updated_timestamp,
      NEW.is_bcws_hq_approved_ind,
      NEW.bcws_hq_approver_name,
      NEW.bcws_hq_approver_user_guid,
      NEW.bcws_hq_approver_user_userid,
      NEW.bcws_hq_approved_timestamp,
      NEW.bcws_hq_approved_comment
    );
    RETURN NEW;
  ...
  ELSIF (TG_OP = 'DELETE') THEN
    ...
    VALUES (
      ...
      OLD.ancillary_funding_provider,
      OLD.approved_comment,
      OLD.endorse_appr_update_name,
      OLD.endorse_appr_update_user_guid,
      OLD.endorse_appr_update_userid,
      OLD.endorse_appr_updated_timestamp,
      OLD.is_bcws_hq_approved_ind,
      OLD.bcws_hq_approver_name,
      OLD.bcws_hq_approver_user_guid,
      OLD.bcws_hq_approver_user_userid,
      OLD.bcws_hq_approved_timestamp,
      OLD.bcws_hq_approved_comment
    );
    RETURN OLD;
