...
CREATE TABLE "wfprev"."contract_phase_code"
(
	"contract_phase_code" varchar(10)	 NOT NULL,    -- contract_phase_code: Contract Phase Code is used to track the general status of contracts that are out for bid to suppliers to complete treatment work for the project. Values are:  	- Contract Out For Bid 	- Contract Awarded 	- Multiple Contracts Out For Bid 	- Multiple Contracts Awarded
...
COMMENT ON TABLE "wfprev"."contract_phase_code"
	IS 'Contract Phase Code is used to track the general status of contracts that are out for bid to suppliers to complete treatment work for the project. Values are:  	- Contract Out For Bid 	- Contract Awarded 	- Multiple Contracts Out For Bid 	- Multiple Contracts Awarded'
;

COMMENT ON COLUMN "wfprev"."contract_phase_code"."contract_phase_code"
	IS 'contract_phase_code: Contract Phase Code is used to track the general status of contracts that are out for bid to suppliers to complete treatment work for the project. Values are:  	- Contract Out For Bid 	- Contract Awarded 	- Multiple Contracts Out For Bid 	- Multiple Contracts Awarded'
;

COMMENT ON COLUMN "wfprev"."contract_phase_code"."description"
	IS 'DESCRIPTION is the display quality description of the code value.'
;

COMMENT ON COLUMN "wfprev"."contract_phase_code"."display_order"
	IS 'DISPLAY ORDER is to allow non alphabetic sorting e.g. M T W Th F S S.'
;

COMMENT ON COLUMN "wfprev"."contract_phase_code"."effective_date"
	IS 'EFFECTIVE_DATE is the date code value becomes effective.'
;

COMMENT ON COLUMN "wfprev"."contract_phase_code"."expiry_date"
	IS 'EXPIRY_DATE is the date code value expires.'
;

COMMENT ON COLUMN "wfprev"."contract_phase_code"."revision_count"
...
COMMENT ON COLUMN "wfprev"."contract_phase_code"."create_user"
	IS 'CREATE_USER is an audit column that indicates the user that created the record.'
;

COMMENT ON COLUMN "wfprev"."contract_phase_code"."create_date"
	IS 'CREATE_DATE is the date and time the row of data was created.'
;

COMMENT ON COLUMN "wfprev"."contract_phase_code"."update_user"
	IS 'UPDATE_USER is an audit column that indicates the user that updated the record.'
;

COMMENT ON COLUMN "wfprev"."contract_phase_code"."update_date"
	IS 'UPDATE_DATE is the date and time the row of data was updated.'
;

/* Create Primary Keys, Indexes, Uniques, Checks */

ALTER TABLE "wfprev"."contract_phase_code" ADD CONSTRAINT "cphcd_pk"
	PRIMARY KEY ("contract_phase_code")
;