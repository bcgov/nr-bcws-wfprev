...
/*  Created On : 08-Jan-2025 11:27:06 AM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
COMMENT ON COLUMN "wfprev"."activity_audit"."silviculture_base_code"
	IS 'silviculture_base_code: Is a foreign key to silviculture_base_code: Silviculture Base Code is a list of Silviculture bases that can be applied as a treatment activity.  Taken from THE.SILV_BASE_CODE table: AU	Audit BR	Brushing CC	Cone Collection CM	Crown Modification DN	Denudation DS	Direct Seeding EP	Experimental Activities FE	Fertilization JS	Juvenile Spacing PC	Pest Control PL	Planting PR	Pruning RC	Recreation RD	Roads SP	Site Preparation SU	Surveys SX	Silviculture Trials'
;

COMMENT ON COLUMN "wfprev"."activity_audit"."silviculture_technique_code"
...
COMMENT ON COLUMN "wfprev"."activity_audit"."silviculture_method_code"
