...
ALTER TABLE "wfprev"."project" ADD CONSTRAINT "prjct_objtcd_primary_fk"
	FOREIGN KEY ("objective_type_code") REFERENCES "wfprev"."objective_type_code" ("primary_objective_type_code") ON DELETE No Action ON UPDATE No Action;
...
ALTER TABLE "wfprev"."project" ADD CONSTRAINT "prjct_objtcd_secondary_fk"
	FOREIGN KEY ("objective_type_code") REFERENCES "wfprev"."objective_type_code" ("secondary_objective_type_code") ON DELETE No Action ON UPDATE No Action;
...
ALTER TABLE "wfprev"."project" ADD CONSTRAINT "prjct_objtcd_tertiary_fk"
	FOREIGN KEY ("objective_type_code") REFERENCES "wfprev"."objective_type_code" ("tertiary_objective_type_code") ON DELETE No Action ON UPDATE No Action;
