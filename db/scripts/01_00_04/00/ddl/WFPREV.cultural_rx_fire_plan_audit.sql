...
/*  Created On : 17-Dec-2024 2:31:51 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."project_guid"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."wui_risk_class_code"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."local_wui_risk_class_code"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."wui_risk_class_comment"
	IS 'Wildland Urban Interface Risk Class Comment are general comments regarding the Wildland Urban Interface Risk Class.'
;

COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."local_wui_risk_class_rationale"
...
COMMENT ON COLUMN "wfprev"."cultural_rx_fire_plan_audit"."coarse_filter_comment"
...
ALTER TABLE "wfprev"."cultural_rx_fire_plan_audit" ADD CONSTRAINT "capfp_aud_pk"
