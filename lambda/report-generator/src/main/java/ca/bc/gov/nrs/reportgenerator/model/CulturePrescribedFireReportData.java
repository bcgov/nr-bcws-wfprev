...
public class CulturePrescribedFireReportData {
    ...
    public Boolean getOutsideWuiInd() { return outsideWuiInd; }
    public void setOutsideWuiInd(Boolean outsideWuiInd) { this.outsideWuiInd = outsideWuiInd; }
    public BigDecimal getTotalRclFilterSectionScore() { return totalRclFilterSectionScore; }
    public void setTotalRclFilterSectionScore(BigDecimal totalRclFilterSectionScore) { this.totalRclFilterSectionScore = totalRclFilterSectionScore; }
    public String getBdfFilterSectionComment() { return bdfFilterSectionComment; }
    public void setBdfFilterSectionComment(String bdfFilterSectionComment) { this.bdfFilterSectionComment = bdfFilterSectionComment; }
    public BigDecimal getTotalBdfFilterSectionScore() { return totalBdfFilterSectionScore; }
    public void setTotalBdfFilterSectionScore(BigDecimal totalBdfFilterSectionScore) { this.totalBdfFilterSectionScore = totalBdfFilterSectionScore; }
    public String getRclFilterSectionComment() { return rclFilterSectionComment; }
    public void setRclFilterSectionComment(String rclFilterSectionComment) { this.rclFilterSectionComment = rclFilterSectionComment; }
    public BigDecimal getTotalCollimpFilterSectionScore() { return totalCollimpFilterSectionScore; }
    public void setTotalCollimpFilterSectionScore(BigDecimal totalCollimpFilterSectionScore) { this.totalCollimpFilterSectionScore = totalCollimpFilterSectionScore; }
    public String getCollimpFilterSectionComment() { return collimpFilterSectionComment; }
    public void setCollimpFilterSectionComment(String collimpFilterSectionComment) { this.collimpFilterSectionComment = collimpFilterSectionComment; }
