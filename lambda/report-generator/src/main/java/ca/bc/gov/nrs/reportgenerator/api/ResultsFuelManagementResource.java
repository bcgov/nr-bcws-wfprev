...
public class ResultsFuelManagementResource {
    ...
    public Response generateXlsx(List<ResultsFuelManagementReportData> fields) {
        ...
        try {
            ...
            return Response.ok(xlsxBytes)
                ...
                .header("Content-Disposition", "attachment; filename=wfprev_results_fuel_management.xlsx")
                .build();
        } catch (Exception e) {
