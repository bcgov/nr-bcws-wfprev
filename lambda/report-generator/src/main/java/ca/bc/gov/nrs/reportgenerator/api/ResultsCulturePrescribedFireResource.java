...
@Path("/results-culture-prescribed-fire")
public class ResultsCulturePrescribedFireResource {
    private static final Logger LOG = Logger.getLogger(ResultsCulturePrescribedFireResource.class);

    private static final String TEST_REPORT_NAME = "WFPREV_RESULTS_CULTURE_PRESCRIBED_FIRE_JASPER.jasper";
    ...
    public Response generateXlsx(List<ResultsCulturePrescribedFireReportData> fields) {
        ...
        try {
            ...
            return Response.ok(xlsxBytes)
                ...
                .header("Content-Disposition", "attachment; filename=wfprev_results_culture_prescribed_fire.xlsx")
                .build();
        } catch (Exception e) {
