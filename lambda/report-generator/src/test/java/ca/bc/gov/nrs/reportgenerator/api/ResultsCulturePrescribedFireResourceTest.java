...
@QuarkusTest
public class ResultsCulturePrescribedFireResourceTest {

    @Test
    public void testGenerateXlsx() {
        ResultsCulturePrescribedFireReportData sample = new ResultsCulturePrescribedFireReportData();
        ...
        .when()
            .post("/results-culture-prescribed-fire")
        .then()
