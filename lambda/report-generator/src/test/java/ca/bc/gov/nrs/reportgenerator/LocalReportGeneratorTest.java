...
public class LocalReportGeneratorTest {
    ...
    private List<FuelManagementReportData> generateMockFuelManagementData(int count) {
        ...
        for (int i = 1; i <= count; i++) {
            ...
            data.setGrossProjectAreaHa(new BigDecimal(random.nextInt(500) + 10));
            data.setTotalEstimatedCostAmount(new BigDecimal(10000 + random.nextInt(90000)));
            data.setFiscalForecastAmount(new BigDecimal(10000 + random.nextInt(40000)));
            data.setFiscalActualAmount(new BigDecimal(5000 + random.nextInt(10000)));
            ...
            data.setFiscalAncillaryFundAmount(new BigDecimal(random.nextInt(5000)));
            data.setFiscalReportedSpendAmount(new BigDecimal(random.nextInt(8000)));
            data.setFiscalPlannedProjectSizeHa(new BigDecimal(random.nextInt(100) + 10));
            data.setFiscalCompletedSizeHa(new BigDecimal(random.nextInt(50)));
            ...
            data.setQ1ForecastAmount(new BigDecimal(random.nextInt(10000)));
            ...
            data.setQ1BudgetHighRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ1BudgetHighRiskRationale("High risk rationale Q1");
            data.setQ1BudgetMediumRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ1BudgetMediumRiskRationale("Medium risk rationale Q1");
            data.setQ1BudgetLowRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ1BudgetLowRiskRationale("Low risk rationale Q1");
            data.setQ1BudgetCompletedAmount(new BigDecimal(random.nextInt(2000)));
            ...
            data.setQ2ForecastAmount(new BigDecimal(random.nextInt(20000)));
            ...
            data.setQ2BudgetHighRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ2BudgetHighRiskRationale("High risk rationale Q2");
            data.setQ2BudgetMediumRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ2BudgetMediumRiskRationale("Medium risk rationale Q2");
            data.setQ2BudgetLowRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ2BudgetLowRiskRationale("Low risk rationale Q2");
            data.setQ2BudgetCompletedAmount(new BigDecimal(random.nextInt(2000)));
            ...
            data.setQ3ForecastAmount(new BigDecimal(random.nextInt(30000)));
            ...
            data.setQ3BudgetHighRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ3BudgetHighRiskRationale("High risk rationale Q3");
            data.setQ3BudgetMediumRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ3BudgetMediumRiskRationale("Medium risk rationale Q3");
            data.setQ3BudgetLowRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ3BudgetLowRiskRationale("Low risk rationale Q3");
            data.setQ3BudgetCompletedAmount(new BigDecimal(random.nextInt(2000)));
            ...
            data.setMarch7ForecastAmount(new BigDecimal(random.nextInt(35000)));
            ...
            data.setMarch7BudgetHighRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setMarch7BudgetHighRiskRationale("High risk rationale Mar7");
            data.setMarch7BudgetMediumRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setMarch7BudgetMediumRiskRationale("Medium risk rationale Mar7");
            data.setMarch7BudgetLowRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setMarch7BudgetLowRiskRationale("Low risk rationale Mar7");
            data.setMarch7BudgetCompletedAmount(new BigDecimal(random.nextInt(2000)));
            ...
            data.setOtherForecastAmount(new BigDecimal(random.nextInt(35000)));
            ...
            data.setOtherBudgetHighRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setOtherBudgetHighRiskRationale("High risk rationale Other");
            data.setOtherBudgetMediumRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setOtherBudgetMediumRiskRationale("Medium risk rationale Other");
            data.setOtherBudgetLowRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setOtherBudgetLowRiskRationale("Low risk rationale Other");
            data.setOtherBudgetCompletedAmount(new BigDecimal(random.nextInt(2000)));
    ...
    private List<CulturePrescribedFireReportData> generateMockCulturePrescribedFireData(int count) {
        ...
        for (int i = 1; i <= count; i++) {
            ...
            data.setGrossProjectAreaHa(new BigDecimal(random.nextInt(200) + 5));
            data.setTotalEstimatedCostAmount(new BigDecimal(5000 + random.nextInt(50000)));
            data.setFiscalForecastAmount(new BigDecimal(4000 + random.nextInt(40000)));
            data.setFiscalActualAmount(new BigDecimal(1000 + random.nextInt(10000)));
            ...
            data.setQ1ForecastAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ1ForecastAdjustmentAmount(new BigDecimal(random.nextInt(1000)));
            data.setQ1ForecastAdjustmentRationale("Adjustment rationale Q1");
            data.setQ1BudgetHighRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ1BudgetHighRiskRationale("High risk rationale Q1");
            ...
            data.setQ2ForecastAmount(new BigDecimal(random.nextInt(10000)));
            data.setQ2ForecastAdjustmentAmount(new BigDecimal(random.nextInt(1000)));
            data.setQ2ForecastAdjustmentRationale("Adjustment rationale Q2");
            data.setQ2BudgetHighRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ2BudgetHighRiskRationale("High risk rationale Q2");
            ...
            data.setQ3ForecastAmount(new BigDecimal(random.nextInt(15000)));
            data.setQ3ForecastAdjustmentAmount(new BigDecimal(random.nextInt(1000)));
            data.setQ3ForecastAdjustmentRationale("Adjustment rationale Q3");
            data.setQ3BudgetHighRiskAmount(new BigDecimal(random.nextInt(5000)));
            data.setQ3BudgetHighRiskRationale("High risk rationale Q3");
